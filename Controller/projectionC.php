...
include_once $_SERVER['DOCUMENT_ROOT'].'/projet_integration/model/projection.php';
	class projectionC {
		
		function ajouterprojection($projection){
			
			
			$sql="INSERT INTO `projection` (`IdProj`, `Salle`, `Date`, `Heure`, `Prix`) VALUES (NULL,:ID,:DA,:HE,:PR)";
