<?php
session_start();
include_once 'C:\xampp\htdocs\projet\Controller\reclamation.php';
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        ...
        <div class="navbar-menu-wrapper d-flex align-items-center">
          ...
          <form method="post" action="recherche_U.php">
                      ...
                      <div class="content-panel">
                          <table class="table table-striped table-advance table-hover">
                            ...
                            <a href="tri_U.php"> 
                              ...
                              <tbody>
                              <?php $requete = "select * from reclamation";
                ...
                {      
                  ...
                  ?>
                              ...
                              <td><?php echo $result[$counter]['ID'];?></td>
                                  <td><?php echo $result[$counter]['sujet'];?></td>
                                  <td><?php echo $result[$counter]['contenu'];?></td>
                                  <td><?php echo $result[$counter]['date'];?></td>
                                  <td><?php echo $result[$counter]['etat'];?></td>
                                  <td>
                                     
                                     <a href="update-profile.php?uid=<?php echo $result[$counter]['ID'];?>"> 
                                     <button class="btn btn-primary btn-xs">Modify<i class="fa fa-pencil"></i></button></a>
