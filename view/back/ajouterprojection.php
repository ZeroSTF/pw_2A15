<?php
    ...
    if (
        ...
        if (
            ...
            header('Location:afficherprojection.php');
        }
        else
...
<head>
    ...
    <body>
        <button><a href="afficheprojection.php">Retour à la liste des projections</a></button>
        <hr>
        ...
        <form action="" method="POST">
            ...
            <tr>
                    <td>
                        <label for="IdProj">IdProj:
                        </label>
                    </td>
                    <td><input type="number" name="IdProj" id="IdProj" maxlength="20"></td>
                </tr>
                <tr>
                    <td>
